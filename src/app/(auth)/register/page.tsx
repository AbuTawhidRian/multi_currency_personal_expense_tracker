    ...
    <div className="animate-fade-in-up">
      ...
      <div className="mb-7">
        ...
        <p className="text-sm text-white/45">
          Start tracking your global finances — it&apos;s free
        </p>
      </div>
        ...
        <div className="space-y-1.5">
          ...
          <ul className="flex flex-wrap gap-x-4 gap-y-1 pt-1">
            {PASSWORD_HINTS.map((hint) => (
              <li key={hint} className="flex items-center gap-1 text-xs text-white/30">
                <CheckCircle2 size={11} className="text-white/20" />
                {hint}
              </li>
            ))}
          </ul>
