...
export default async function IncomePage(props: {
  ...
  const [transactions, allIncomeTxs, countries, currencies, categories, exchangeRates, paymentMethods] =
    await Promise.all([
  ...
  Object.entries(categoryIncomeMap).forEach(([cat, amount]) => {
  ...
  const categoryBreakdown = Object.entries(categoryIncomeMap)
    .map(([name, amount]) => ({
      name,
      amount,
      percentage: allTimeIncome > 0 ? (amount / allTimeIncome) * 100 : 0,
    }))
    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Track salaries, freelance earnings, remittances, and dividends.
          </p>
        </div>
        <AddTransactionModal
          countries={countries}
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl md:text-3xl font-bold">
              {allTimeIncome.toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </div>
      ...
      {categoryBreakdown.length > 0 && (
        <div className="space-y-3">
          <h2 className="text-lg font-semibold tracking-tight">Income Distribution</h2>
      ...
      {/* Income Activity History */}
      <div className="space-y-6">
        <h2 className="text-lg font-semibold tracking-tight">Income History</h2>
